...
用法（macOS）：
    ...
    .venv/bin/python hik_fetch_latest.py

输出：
  - hik_latest_refresh.json     原始数据
  - hik_latest_metrics.json     精简指标
"""
...
OUT = BASE / "hik_latest_refresh.json"
METRICS_OUT = BASE / "hik_latest_metrics.json"

SYMBOL = "002415"  # 海康威视 深市
SECID = "0.002415"  # 东财 secid（0 = 深市）
FALLBACK_PRICE = 38.05
...
def get_latest_price() -> float:
    ...
    try:
        ...
        resp = requests.get(f"https://qt.gtimg.cn/q=sz{SYMBOL}", timeout=10)
        resp.encoding = "gbk"
