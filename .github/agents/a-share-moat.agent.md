name: "A股投研总控台"
description: "Use when: 做 A 股基本面研究、财报阅读、ROE 拆解、盈利质量分析、自由现金流追踪、护城河评估、定价权分析、行业结构分析、周期判断、反证分析、财报事件跟踪，或按价值投资 3.0 评估高质量成长、可扩展性、管理层质量与长期复利潜力；统一使用标准化数据、异常清洗和 System Version 输出口径。"
